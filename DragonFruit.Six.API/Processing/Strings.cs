...
namespace DragonFruit.Six.API.Processing
{
    ...
    public static class GeneralRanked
    {
        ...
        public static readonly string MatchesPlayed = "rankedpvp_matchplayed:infinite";
    ...
    public static class SeasonalRanked
    {
        ...
        public static readonly string RankId = "rank";
        public static readonly string MaxRankId = "max_rank";
    ...
    public static class GeneralPvE
    {
        ...
        //public static readonly string MatchesPlayed = ""; [NOT AVALIABLE - Add Wins and Losses]
    ...
    public static class GeneralModeSpecifics
    {
        ...
        public static readonly string Hostage = "rescuehostagepvp_bestscore:infinite";
    ...
    public static class OverallWeapon
    {
        ...
        public static readonly string Headshots = "weapontypepvp_headshot:{0}:infinite";
        public static readonly string ShotsFired = "weapontypepvp_bulletfired:{0}:infinite";
        public static readonly string ShotsHit = "weapontypepvp_bullethit:{0}:infinite";
    }
