...
namespace DragonFruit.Six.API {
  public static class Endpoints {
    ...
    public static readonly Dictionary<Platforms, string>GameSpaceIds =
        new Dictionary<Platforms,
                       string>{[Platforms.PSN] =
                                   "05bfb3f7-6c21-4c42-be1f-97a33fb5cf66",
                               [ Platforms.XB1 ] =
                                   "98a601e5-ca91-4440-b1c5-753f601a2c90",
                               [ Platforms.PC ] =
                                   "5172a557-50b5-4665-b7db-e3f2e8c5041d"};

    public static readonly Dictionary<Platforms, string>Stats = new Dictionary<
        Platforms, string>{
            [Platforms.PSN] =
    ...
    public static readonly Dictionary<
        Platforms, string>RankedStats = new Dictionary<Platforms, string>{
            [Platforms.PSN] =
    ...
    public static readonly Dictionary<
        Platforms, string>ProfileInfo = new Dictionary<Platforms, string>{
            [Platforms.PSN] =
